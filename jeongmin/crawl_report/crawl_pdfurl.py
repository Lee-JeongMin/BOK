...
for p in page:
    url = "https://finance.naver.com/research/debenture_list.nhn?keyword=&brokerCode=&searchType=writeDate&writeFromDate=2012-01-01&writeToDate=2017-12-31&x=38&y=19&page="+str(p)
    driver.get(url)
